...
const columns = [
  ...
  { id: "descripcion", label: "Descripción", width: 200, align: "left" },
  { id: "cliente", label: "Cliente", width: 400, align: "left" },
  { id: "monto", label: "Monto", width: 200, align: "left" },
  { id: "fecha_movimiento", label: "Fecha", width: 200, align: "center" },
                      ...
                      return (
                        <td key={"col" + indexColumn} align={column.align}>
                          ...
                          :column.id === "cliente" ? (
                            ...
                            // Renderizar otros valores directamente
                            value
                          )}
                        </td>
                      );
